...
<img src="examples/image.jpg" width="480" alt="Input Image" />
<img src="examples/preproc.jpg" width="480" alt="Preprocessed Image" />
...
Based on these concepts, mask the portion of imagee of interest. On an empty road, only lane lines are present in the image. 
